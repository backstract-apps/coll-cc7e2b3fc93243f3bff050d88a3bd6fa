...
app = FastAPI(title='Backstract Generated APIs - coll-cc7e2b3fc93243f3bff050d88a3bd6fa', debug=False,
              docs_url='/interesting-einstein-64b6bac6e93311ef95300242ac12000392/docs',
              openapi_url='/interesting-einstein-64b6bac6e93311ef95300242ac12000392/openapi.json')
...
app.include_router(
    router,
    prefix='/interesting-einstein-64b6bac6e93311ef95300242ac12000392/api',
    tags=['APIs v1']
)
